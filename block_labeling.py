...
class BlockLabeler:
    ...
    def _load_vessel_specs(self) -> List[Dict]:
        ...
        # 기본값(업무 공유 스펙)
        return [
            {"id": 1, "name": "자항선1", "width": 170, "height": 62},
            {"id": 2, "name": "자항선2", "width": 84, "height": 36},
            {"id": 3, "name": "자항선3", "width": 120, "height": 32},
            {"id": 4, "name": "자항선4", "width": 130, "height": 40},
            {"id": 5, "name": "자항선5", "width": 116, "height": 32},
        ]
