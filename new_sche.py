...
# 자항선별 색상 정의
VESSEL_COLORS = {
    '자항선1': '#1f77b4', '자항선2': '#ff7f0e', '자항선3': '#2ca02c',
    '자항선4': '#d62728', '자항선5': '#9467bd',
}
...
class VoyageScheduleVisualizer:
    ...
    def load_and_prepare_data(self):
        ...
        for voyage_id, blocks in self.voyage_data.items():
            ...
            start_date = end_date - timedelta(days=cycle_days - 1)
    ...
    def _build_voyage_ranges(self):
        ...
        for line in logs:
            ...
            if match:
                ...
                key = f"{vessel}_{end_str}"
                ranges[key] = {'start': start_date, 'end': end_date, 'vessel': vessel}
        
        return ranges

    def generate_html_dashboard(self, output_file='dashboard_report.html'):
        """Canvas 기반 간트 차트로 HTML 대시보드 생성 (lv3_voyage_gantt.html 스타일)"""
